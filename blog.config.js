...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Spidey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '答辩S', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.spideycsgo.top.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, CS2', // 网站关键词 英文逗号隔开
